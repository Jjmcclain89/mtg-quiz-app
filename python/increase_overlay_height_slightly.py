#!/usr/bin/env python3
"""
Increase Overlay Height Slightly
MTG Quiz App - Make overlay a bit taller to fully cover name text

Fix: Increase height slightly to cover all visible name text
Keep: Same positioning and length that work well

Run from project root: python python/increase_overlay_height_slightly.py
"""
...
def update_card_guessing_game_component():
    """Update CardGuessingGame with slightly taller overlay"""
                ...
                {!gameState.isGuessSubmitted && (
                  <div 
                    ...
                    style={{
                      ...
                      height: '4.2%', // Slightly increased height (was 3.5%, now 4.2%)
...
def main():
    ...
    print("📏 Increasing Overlay Height Slightly")
    print("=" * 37)
    ...
    try:
        ...
        print("   • Increased overlay height to 4.2% (was 3.5%)")
        print("   • Should now fully cover all visible name text")
        print("   • Keeps same positioning and length")
        print("   • Still avoids bleeding into artwork")
    except Exception as e:
        print(f"❌ Error updating CardGuessingGame.tsx: {e}")
        return 1
    
    print("\n" + "=" * 37)
    print("✅ SUCCESS! Overlay height increased for complete coverage.")
    print("\n📏 The overlay should now fully hide all card name text!")
    print("   • Slightly taller to cover remaining visible text")
    print("   • Perfect balance between coverage and precision")
